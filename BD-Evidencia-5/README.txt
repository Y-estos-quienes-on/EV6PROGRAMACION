...
Ya que permiten realizar inserts “orgánicos”, a diferencia de otros compiladores online.

Nota: Ambos links ya tienen seleccionado SQL Server por defecto.
Tip: SQL Fiddle suele mostrar el output separado por consulta, lo que ayuda a entender mejor los resultados.

Pasos para ejecutar el script:
1) Copiar el contenido del archivo QueryOnline
2) Ingresar a OneCompiler o SQL Fiddle y asegurarse de que este seleccionada la opción SQL Server.
